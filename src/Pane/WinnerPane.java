...
public class WinnerPane extends BorderPane{
	
	public WinnerPane() {
		//Creating the text/font/background for the pane
		HBox descBox = new HBox();
		Text descText = new Text("YOU'VE WON, PRESS THE EXIT BUTTON TO CLOSE THE PROGRAM");
		...
		//setting the font and setting the position 
